...
class ESA:
    ...
    @staticmethod
    def sparse_vector_dot(vector_one, vector_two):
        vec_mul_res = 0
    ...
    @staticmethod
    def sparse_vector_dot_one_line(vector_one, vector_two):
...
def text_to_most_important_tokens(text, tfidf_extractor, lang="english", minimum_percentage=0.25, also_return_all_tokens=False):
    if not lang == "english":
        return 0
    t_tokens = split_to_tokens_without_stopwords(text, lang)
